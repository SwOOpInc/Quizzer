package com.akagra.quizapp.Activity;
...
import com.akagra.quizapp.Adapter.WithdrawHistoryAdapter;
import com.akagra.quizapp.Model.ProfileModel.ProfileModel;
import com.akagra.quizapp.Model.WithdrawalModel.Result;
import com.akagra.quizapp.Model.WithdrawalModel.WithdrawalModel;
import com.akagra.quizapp.R;
import com.akagra.quizapp.Util.PrefManager;
import com.akagra.quizapp.Util.Utility;
import com.akagra.quizapp.Webservice.AppAPI;
import com.akagra.quizapp.Webservice.BaseURL;
...
public class WithdrawHistory extends AppCompatActivity {
    ...
    List<com.akagra.quizapp.Model.ProfileModel.Result> profileList;
                ...
                try {
                    if (response.code() == 200 && response.body().getStatus() == 200) {
                        ...
                        if (response.body().getResult().size() > 0) {
                            profileList = new ArrayList<com.akagra.quizapp.Model.ProfileModel.Result>();
